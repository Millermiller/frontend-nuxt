...
import PuzzleRepository from '~/src/Scandinaver/Puzzle/Infrastructure/puzzle.repository'
import { BaseService } from '~/src/Scandinaver/Core/Application/base.service'
